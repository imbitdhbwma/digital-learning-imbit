...
public class BadgeBakery extends HttpServlet {
	...
	public static byte[] bakeBadge(String useremail, String country) throws IOException, SQLException {
		...
		File svgFile = new File("/opt/tomcat/webapps/brillianQUIZ/img/badges/tmp_badge.svg");
		try {
...
//			fileInputStream.close();
	...
	private static String getSVGString(String country) {
		...
		switch (country) {
		case "Brazil":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_brazil.svg";
			break;
		case "Spain":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_spain.svg";
			break;
		case "China":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_china.svg";
			break;
		case "USA":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_USA.svg";
			break;
		case "Sweden":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_sweden.svg";
			break;
		case "India":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_india.svg";
			break;
		case "Germany":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_germany.svg";
			break;
		case "Turkey":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_turkey.svg";
			break;
		case "Australia":
			fileLocation = "/opt/tomcat/webapps/brillianQUIZ/img/badges/badge_australia.svg";
			break;
		}
		return fileLocation;
