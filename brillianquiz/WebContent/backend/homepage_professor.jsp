						...
						<%
							if (request.getAttribute("groups") != null) {
								...
								for (int i = 0; i < groups.size(); i++) {//ArrayList<String> row : groups
									...
									out.println("<form action=\"" + "http://brillianideas.com:8080/brillianQUIZ"
									...
									out.println("<td><form action=\"" + "http://brillianideas.com:8080/brillianQUIZ" + "/DeleteGroup\" method=\"post\">"
									...
									out.println("<td><form action=\"" + "http://brillianideas.com:8080/brillianQUIZ"
									...
									*/
									out.println("<form action=\"" + "http://brillianideas.com:8080/brillianQUIZ" + "/SetUserProgress\" method=\"post\">"
											+ "<input type=\"text\" name=\"group_id\" value=\"" + groups.get(i).get(0)
											+ "\" style=\"display:none\"/>"
