...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<a href="https://www.dropbox.com/s/vy3537b9ifjzsg2/brillianQUIZ%20Doku%20Gesamt_final.pdf?dl=0"
				target="_blank">
				<div class="col-md-2 col-sm-3 ">
					<div class="card">
						<div class="card-image">
			...
			</a> <a href="http://ec2-54-191-39-238.us-west-2.compute.amazonaws.com:8080/" target="_blank">
				<div class="col-md-2 col-sm-3 ">
					<div class="card">
						<div class="card-image">
	...
	<footer class="footer ignoreMe">
		<div class="container ignoreMe">
			<p class="text-margin ignoreMe">
				...
				developed with <span id="counter"></span> <span id="easter-heart" class="heart">♥</span> in Mannheim
			</p>
		</div>
	</footer>
	<script>
