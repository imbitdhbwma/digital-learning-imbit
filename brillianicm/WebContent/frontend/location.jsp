<div class="locationBackgroundContainer easyui-panel" data-options="fit:true,border:false">
  ...
  <div class="pictureContainer" style=" background: #d5edf3 url('../images/WelcomePage.png');width: 100%; height: 100%;" data-options="fit:true,border:false">
    <div class="bgimg" style="width: 60% !important; float: right !important;"></div>
    <h4 style="text-transform:none; text-align: center;">
      Please select the country from the drop-down list above
    </h4>
  </div>
  ...
  <div class="allocationContainer easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer margin-left">
      ...
      <div class="buttonContainer">
        <div id="continueButton" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="allocationContainerTwo easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer margin-left">
      ...
      <div class="buttonContainer">
        <div id="continueButtonTwo" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="allocationContainerThree easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer margin-left">
      ...
      <div style="clear: both;"></div>
      <div class="buttonContainer">
        <div id="continueButtonThree" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="matrixAllocationContainer easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer">
      ...
      <div class="tileAcceptorContainer">
        ...
        <div class="buttonContainer">
          <div id="continueButtonMatrix" class="easyui-linkbutton allocationButton">
            Done
          </div>
        </div>
      </div>
  ...
  <div class="textBox easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer">
      ...
      <div class="buttonContainer button-bottom">
        <div id="continueButtonTextBox" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="matrixAllocationContainerStandard easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer">
      ...
      <div class="buttonContainer">
        <div id="continueButtonMatrixStandard" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="scrollBar easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer">
      ...
      <div class="buttonContainer button-bottom2">
        <div id="continueButtonScrollButton" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="matrixAllocationContainerAlternate easyui-panel panel-body" data-options="fit:true,border:false">
    ...
    <div class="centerContainer">
      ...
      <div class="infoContainer">
        <table class="eventInfoTable bc">
          <tr>
            ...
            <td class="elementInfo-header border_bottom">
              Description
              <tr>
      ...
      <div class="buttonContainer">
        <div id="continueButtonMatrixAlternate" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
  ...
  <div class="factsheetContainer easyui-panel" style="background-color: #D5ECF2;" data-options="fit:true,border:false">
    <div style="float: right">
      ...
      <p>
        <img id="sideimg3" src="" class="img-factsheet2" alt="Frau mit T�t�" />
      </p>
    </div>
    ...
    <div>
      <table>
        ...
        <tr>
          ...
          <td>
            <div id="area" class="txt-factsheet2" style="float: left; padding-right: 10px"></div>
            <div class="txt-factsheet2">km<sup>2</sup></div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <a href="" id="moreinfo" class="link-factsheet" target="_blank"></a>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="buttonContainer">
      <div id="continueButtonFactsheet" class="easyui-linkbutton allocationButton">
        Done
      </div>
    </div>
  </div>
...
02.03.2016 -->
  ...
  <div class="mapAllocationContainer easyui-panel" style="background-color: #D5ECF2;" data-options="fit:true,border:false">
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-6">
          <div id="mapContainer" style="background-image: url('images/DE_SoccerMap.jpg')"></div>
        </div>
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="buttonContainer">
          <div id="continueButtonMapAllocation" class="easyui-linkbutton allocationButton">
            Done
          </div>
        </div>
      </div>
  ...
  <div class="allocationContainerFour easyui-panel" style="background-color: #D5ECF2;" data-options="fit:true,border:false">
    <div class="bgimg"></div>
    <div class="centerContainer margin-left">
      <div class="description"></div>
      <div class="container">
      ...
      <div class="dragInfoContainerTwo"></div>
      <div class="buttonContainer">
        <div id="continueButtonAllocationFour" class="easyui-linkbutton allocationButton">
          Done
        </div>
      </div>
    </div>
